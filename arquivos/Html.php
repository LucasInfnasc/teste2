...
HTML;
    ...
    {
        /*$message = "<a style='padding: 5px; color: #FFFFFF; font-size: 15px; font-weight: bold; text-transform: uppercase; transition: all 0.3s; text-align: center; box-sizing: border-box; background: #f9201d; border-radius: 7px; box-shadow: 5px 5px 10px #206bc4; ' href=\"https://www.mark01.com.br/\" target=\"Blank\">";
        $message .= "Mark01 Soluções Tecnológicas";
